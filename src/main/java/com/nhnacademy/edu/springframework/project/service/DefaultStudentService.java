...
public class DefaultStudentService implements StudentService {
    ...
    public Collection<Student> getPassedStudents() {
        ...
        return studentRepository.findAll().stream().filter(student -> student.getScore().isFail()).collect(Collectors.toCollection(ArrayList::new));
    }
    ...
    public Collection<Student> getStudentsOrderByScore() {
        ...
        return studentRepository.findAll().stream().sorted(Comparator.comparingInt(student -> student.getScore().getScore())).collect(Collectors.toCollection(ArrayList::new));
    }
